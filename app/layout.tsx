  ...
  return (
    <html lang="en" className="scroll-smooth" data-client={activeClient?.slug ?? "apex"}>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Source+Serif+Pro:wght@400;600&family=Source+Serif+4:ital,opsz,wght@0,8..60,300..900;1,8..60,400..700&family=JetBrains+Mono:wght@400;500;600&display=swap"
          rel="stylesheet"
        />
        {brandStyle ? (
